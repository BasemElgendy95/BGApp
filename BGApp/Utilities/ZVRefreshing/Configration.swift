...
struct ConstantsZZZ {
    struct Header {
        static let idle = R.string.localizable.pull_down_to_refresh().locale
        static let pulling = R.string.localizable.release_to_refresh().locale
        static let refreshing = R.string.localizable.release_to_refresh().locale
    ...
    struct Footer {
        ...
        struct Auto {
            static let idle = R.string.localizable.pull_up_to_load_more().locale
            static let refreshing = R.string.localizable.loading().locale
            static let noMoreData = R.string.localizable.no_more_data().locale
        }
        
        struct Back {
            static let idle = R.string.localizable.pull_up_to_load_more().locale
            static let pulling = R.string.localizable.release_to_load_more().locale
            static let refreshing = R.string.localizable.loading().locale
            static let noMoreData = R.string.localizable.no_more_data().locale
        }
    }
    ...
    struct State {
        static let lastUpdatedTime = R.string.localizable.last_update().locale
        static let dateToday = R.string.localizable.today().locale
        static let noLastTime = R.string.localizable.no_record().locale
        static let noMoreData = R.string.localizable.no_more_data().locale
...
internal extension UILabel {
    ...
    var textWidth: CGFloat {
        ...
        let textWidth = (text as NSString).boundingRect(with: size,
                                                        ...
                                                        attributes: [NSAttributedString.Key.font: self.font ?? UIFont.systemFontSize],
...
func local(string key: String, comment: String = "") -> String {
