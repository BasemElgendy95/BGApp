...
extension UIColor {
    ...
    class var colorFonrDark : UIColor {
        return UIColor(named: "color_font_dark")!
    }
    class var colorFontPlaceholder : UIColor {
        return UIColor(named: "color_font_placeholder")!
    }
    class var colorLightBack : UIColor {
        return UIColor(named: "color_light_back")!
    }
    class var colorMainShadow : UIColor {
        return UIColor(named: "color_main_shadow")!
    }
    class var colorMain : UIColor {
        return UIColor(named: "color_main")!
    }
    class var colorSecondary : UIColor {
        return UIColor(named: "color_secondary")!
    }
    class var colorTFBorder : UIColor {
        return UIColor(named: "color_TF_border")!
    }

    class var colorLightText : UIColor {
        return UIColor(named: "color_light_text")!
    }
}
